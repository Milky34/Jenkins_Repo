...
public class BaseClassForCRM {
	...
	public void beforeMethod() throws IOException {
		...
		String PASSWORD =System.getProperty("password",file.getDataFromPropFile("password"));
		String USERNAME =System.getProperty("username",file.getDataFromPropFile("username"));
		wu.url(driver, URL);
